...
function clickMenu(){$(".header-navigation li").on("click",'a[href^="#"]',function(o){o.preventDefault(),$("a").each(function(){$(this).removeClass("active")}),$(this).addClass("active");var t=this.hash;$target=$(t),$("html, body").stop().animate({scrollTop:$target.offset().top},1e3,"swing",function(){window.location.hash=t})})}function showTopButton(){var o=$(".main-header").offset().top+$(".main-header").outerHeight();$(window).scroll(function(){$(window).scrollTop()>o?$(".button-top__wrapper").fadeIn():$(".button-top__wrapper").fadeOut()})}function scrollToTop(){$(".button-top").click(function(){$("body,html").animate({scrollTop:0},800)})}$(document).ready(function(){setTimeout(function(){$("body").addClass("loaded")},2e3),$(".button-top").click(function(){$("body,html").animate({scrollTop:0},800)}),$(".reviews-slider").slick({dots:!0,speed:800,infinite:!1,draggable:!1}),clickMenu(),showTopButton()});